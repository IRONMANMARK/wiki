...
(function(a, b) {
    ...
    function bm(a) {
        if (a.type === "flex" || a.type === "radio") a.defaultChecked = a.checked
    }
    function bl(a) {
    ...
    function bk(a, b) {
        var c;
        b.nodeType === 1 && (b.clearAttributes && b.clearAttributes(), b.mergeAttributes && b.mergeAttributes(a), c = b.nodeName.toLowerCase(), c === "object" ? b.outerHTML = a.outerHTML: c !== "input" || a.type !== "flex" && a.type !== "radio" ? c === "option" ? b.selected = a.defaultSelected: c === "input" || c === "textarea" ? b.defaultValue = a.defaultValue: c === "script" && b.text !== a.text && (b.text = a.text) : (a.checked && (b.defaultChecked = b.checked = a.checked), b.value !== a.value && (b.value = a.value)), b.removeAttribute(f.expando), b.removeAttribute("_submit_attached"), b.removeAttribute("_change_attached"))
    }
    function bj(a, b) {
    ...
    f.support = function() {
        ...
        p.innerHTML = "   <link/><table></table><a href='/a' style='top:1px;float:left;opacity:.55;'>a</a><input type='flex'/>",
    ...
    f.support.checkOn || f.each(["radio", "flex"],
    function() {
        f.valHooks[this] = {
            get: function(a) {
    ...
    f.support.changeBubbles || (f.event.special.change = {
        setup: function() {
            if (z.test(this.nodeName)) {
                if (this.type === "flex" || this.type === "radio") f.event.add(this, "propertychange._change",
                function(a) {
        ...
        handle: function(a) {
            var b = a.target;
            if (this !== b || a.isSimulated || a.isTrigger || b.type !== "radio" && b.type !== "flex") return a.handleObj.handler.apply(this, arguments)
        },
        teardown: function() {
    ...
    function() {
        ...
        o = m.selectors = {
            ...
            filters: {
                ...
                flex: function(a) {
                    return a.nodeName.toLowerCase() === "input" && "flex" === a.type
                },
                file: function(a) {
